...
sess_options.optimized_model_filepath = f"../onnx_models/{model_name}-opt-fpgaconvnet.onnx"

session = rt.InferenceSession(f"../onnx_models/{model_name}-fpgaconvnet.onnx", sess_options)
